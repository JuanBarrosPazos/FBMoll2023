<?php
  ...
  PRIMARY KEY  (`idv`)
	...
	/************	COMPROBAMOS LAS TABLAS CLIENTE	*****************/

	global $tablasClienteLog; 
	if(file_exists("../Mod_Cliente/conect/tablasCrearIntegraAdmin.php")){
		require "../Mod_Cliente/conect/tablasCrearIntegraAdmin.php";
	} else { $tablasClienteLog = ""; }
	...
	/************	PASAMOS LOS PARAMETROS A .LOG	*****************/
		...
		$text = $text.PHP_EOL.$data0.$table1.$table2.$table3.$table4.$table5.$tablasAgendaLog.$tablasContactoLog.$tablasClienteLog;
